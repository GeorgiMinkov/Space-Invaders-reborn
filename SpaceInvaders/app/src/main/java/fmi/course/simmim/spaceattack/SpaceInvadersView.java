package fmi.course.simmim.spaceattack;
...
public class SpaceInvadersView extends SurfaceView implements Runnable{
    ...
    private void update(){
        ...
        for(int i = 0; i < numInvaders; i++){
            if(invaders[i].getVisibility()) {
                ...
                if (invaders[i].getCoordinateX() > screenX - invaders[i].getLength()
        ...
        if(bumped){
            ...
            for(int i = 0; i < numInvaders; i++){
                ...
                if(invaders[i].getCoordinateY() > screenY - screenY / 10){
                    lost = true;
                }
    ...
    private void draw(){
        ...
        if (ourHolder.getSurface().isValid()) {
            ...
            canvas.drawBitmap(playerShip.getBitmap(), playerShip.getCoordinateX(), screenY - playerShip.getHeight(), paint);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        switch (motionEvent.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                if(motionEvent.getY() < screenY - screenY / 8) {
                    // Shots fired
                    if(bullet.shoot(playerShip.getCoordinateX()+ playerShip.getLength()/2,screenY,bullet.UP)){
